...
UserModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([
                { name: user_entity_1.User.name, schema: user_entity_1.UserSchema, collection: 'users' },
                { name: point_entity_1.Point.name, schema: point_entity_1.PointSchema, collection: 'point' }
            ]),
        ],
